 ...
 * @author Joshua
 */
public class UnadjustTB extends javax.swing.JFrame {
    ...
    public void loadUTB() {
        ...
        String query = "SELECT account_name, debit_total, credit_total FROM unadjusted_ledger WHERE project_id = ?";
        ...
        try (Connection conn = DriverManager.getConnection(
            ...
            List<UTBRow> rows = new ArrayList<>();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    rows.add(new UTBRow(accountName, debit, credit));
    ...
    // Helper class
    private static class UTBRow {
        String accountName;
        BigDecimal debit;
        BigDecimal credit;

        public UTBRow(String accountName, BigDecimal debit, BigDecimal credit) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UnadjustTB(null).setVisible(true);
            }
        });
    }
